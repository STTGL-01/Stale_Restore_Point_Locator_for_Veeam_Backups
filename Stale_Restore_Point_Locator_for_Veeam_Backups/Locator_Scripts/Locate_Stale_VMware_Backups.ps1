...
Write-Host "   Eligible Stale Restore Points - VMware Report" -ForegroundColor Cyan
Write-Host "================================================" -ForegroundColor Cyan
Write-Host ""
...
if ($results.Count -eq 0) {
    ...
    Write-Host "VMware jobs exist, but no eligible orphaned chains were found before the cutoff." -ForegroundColor Green
