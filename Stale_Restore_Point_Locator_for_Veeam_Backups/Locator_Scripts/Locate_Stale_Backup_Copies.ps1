# ============================================================
# Stale Restore-Point Report — Backup Copy Jobs
# Detects:
#   Backup Copy chains by TypeToString and Platform
...
Write-ReportLog "===== Backup Copy Report Started ====="
...
Write-ReportLog "Backup Copy jobs detected: $($copyBackups.Count)"
...
if ($copyBackups.Count -eq 0) {
    ...
    Write-ReportLog "RESULT: no Backup Copy jobs detected"
