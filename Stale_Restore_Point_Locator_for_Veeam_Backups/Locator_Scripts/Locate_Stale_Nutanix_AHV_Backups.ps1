...
Write-Host "   Eligible Stale Restore Points - Nutanix AHV Report" -ForegroundColor Cyan
Write-Host "=====================================================" -ForegroundColor Cyan
Write-Host ""
...
if ($results.Count -eq 0) {
    ...
    Write-Host "Nutanix AHV jobs exist, but no eligible orphaned chains were found before the cutoff." -ForegroundColor Green
